      ...
      <section className="relative py-20 px-6 mt-12 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
            From intimate gatherings to grand celebrations, we create magical experiences tailored to your vision.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-[#006400] mb-4">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 border border-[#d4af37]">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <div className="flex justify-between items-center">
                    ...
                    <a 
                      href="/inquiryform"
                      className="bg-[#d4af37] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#b8860b] transition-colors duration-300 transform hover:scale-105"
                    >
                      Get Quote
                    </a>
                  </div>
